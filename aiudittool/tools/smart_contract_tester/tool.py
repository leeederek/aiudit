...
HUMAN_MESSAGE_TEMPLATE = (
    "Please write unit test cases for a smart contract in Solidity 0.8.19 that conforms to the following description. "
    " "
    "Description:\n"
    "{description}\n\n"
...
class SmartContractTesterToolInput(BaseModel):
...
class SmartContractTesterTool(BaseTool):
    name = "SmartContractTester"
    description = "Useful for writing EVM-compatible smart contracts test cases. Returns the path to the .sol file."
    args_schema: Type[BaseModel] = SmartContractTesterToolInput
